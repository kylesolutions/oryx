...
#     """
#     Automatically create a Stock Entry when a Purchase Receipt is saved or submitted.
#     """
#     try:
...
#                 if row.vehicle:
#                     if not frappe.db.exists("Warehouse", row.vehicle):
#                         frappe.throw(f"Target warehouse '{row.vehicle}' does not exist.")
#                     target_warehouses.append(row.vehicle)
...
#                     if vehicle_row.vehicle == t_warehouse:
                        
#                         loaded_qty = float(vehicle_row.loaded_qty)  
#                         break
