...
#         kyle_trip.loading_point = doc.loading_point
...
#     if created_trips > 0:
#         frappe.msgprint(f"{created_trips} Goods Receive Trips Created and Save.")
#     else:
#         frappe.msgprint("No Goods Receive Trips were save.")
